...
$routexxx = 'resuimpa';
$controll = 'Backend\Administ\ResuimpaController@';
Route::group(['prefix' => '{padrexxx}/resultado-impactos'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getBResuimpas',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
...
Route::group(['prefix' => 'resultado-impacto'], function () use ($routexxx, $controll) {
