...
$routexxx = 'consecue';
$controll = 'Backend\Administ\Probabil\ConsecueController@';
Route::group(['prefix' => '{padrexxx}/consecuencias'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getBConsecues',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
...
Route::group(['prefix' => 'consecuencia'], function () use ($routexxx, $controll) {
