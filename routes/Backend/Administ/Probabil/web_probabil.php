...
$routexxx = 'probabil';
$controll = 'Backend\Administ\Probabil\ProbabilController@';
Route::group(['prefix' => '{padrexxx}/probabilidads'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getBProbabils',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
...
Route::group(['prefix' => 'probabilidad'], function () use ($routexxx, $controll) {
