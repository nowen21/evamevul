...
$routexxx = 'consprob';
$controll = 'Backend\Administ\Probabil\ConsprobController@';
Route::group(['prefix' => '{padrexxx}/consecuencia-probabilidads'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getBConsprobs',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
...
Route::group(['prefix' => 'consecuencia-probabilidad'], function () use ($routexxx, $controll) {
