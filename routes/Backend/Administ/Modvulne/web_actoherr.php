...
$routexxx = 'actoherr';
$controll = 'Backend\Administ\Modvulne\ActoherrController@';
Route::group(['prefix' => '{padrexxx}/actor-herramientas'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getBActoherrs',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
...
Route::group(['prefix' => 'actor-herramienta'], function () use ($routexxx, $controll) {
