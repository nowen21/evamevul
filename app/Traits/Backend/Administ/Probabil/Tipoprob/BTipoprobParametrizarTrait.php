...
namespace App\Traits\Backend\Administ\Probabil\Tipoprob;

/**
 * Este trait permite armar las consultas para ubicacion que arman las datatable
 */
trait BTipoprobParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'TIPO CONSECUENCIAS';
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'sinperfi';
        $this->opciones['rutacarp'] = 'Backend.Administ.Probabil.';
        ...
        $this->opciones['tituloxx'] = "TIPO CONSECUENCIAS";  
