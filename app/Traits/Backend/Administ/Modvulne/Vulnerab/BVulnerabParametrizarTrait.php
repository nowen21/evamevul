...
namespace App\Traits\Backend\Administ\Modvulne\Vulnerab;

/**
 * Este trait permite armar las consultas para ubicacion que arman las datatable
 */
trait BVulnerabParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'HERRAMIENTAS';
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'sinperfi';
        $this->opciones['rutacarp'] = 'Backend.Administ.Modvulne.';
        ...
        $this->opciones['tituloxx'] = "HERRAMIENTAS";  
