...
trait BModvulnePestaniasTrait
{
     ...
     */
    public $pestania = [
        ['herramie', '', [], 'HERRAMIENTAS', true, '', 'Lista de activos para asignar vulnerabilidades'],
        ['vulnacti', '', [], 'ACTIVOS', true, '', 'Lista de activos para asignar vulnerabilidades'], // por mínimo debe tener un controllaor
        ['vulnerab', '', [], 'VULNERABILIDAD', false, '', 'Lista de activos para asignar vulnerabilidades'],
       
        ['vulnacto', '', [], 'VULNERABILIDAD-ACTOR', false, '', 'Lista de activos para asignar vulnerabilidades'],
        ['actoherr', '', [], 'ACTOR-HERRAMIENTAS', false, '', 'Lista de activos para asignar vulnerabilidades'],
        // ['tipoprob', '', [], 'TIPO DE PROBABILIDAD', true, '', 'Administración de los tipos de probabilidad'], // por mínimo debe tener un controllaor
        // ['consecue', '', [], 'CONSECUENCIAS', false, '', 'Administración de de las consecuencias'],
        // ['probabil', '', [], 'PROBABILIDADES', false, '', 'Administración de las probabilidades'],
        // ['consprob', '', [], 'CONSECUENCIA-PROBABILIDAD', false, '', 'Administrción de la asociacion de la consecuencia con la probabilidad'],
    ];
    /**
